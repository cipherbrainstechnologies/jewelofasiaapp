      ...
      child: Scaffold(
        ...
        body: Consumer<ProfileProvider>(builder: (context, profileProvider, _) {
          return configModel.loyaltyPointStatus!? _isLoggedIn ? profileProvider.userInfoModel != null ? SafeArea(
                                            ...
                                            builder: (context, walletProvider, _) {
                                              return Column(children: [
                                                Column(children: [
                                                  ...
                                                  ) :  NoDataScreen(isFooter: false, title: getTranslated('no_result_found', context)) : WalletShimmer(walletProvider: walletProvider),
              ...
              ) : Center(child: CustomLoader(color: Theme.of(context).primaryColor)) : const NotLoggedInScreen() : NoDataScreen(title: getTranslated('no_result_found', context));
        }),
      ),
    );
  }
