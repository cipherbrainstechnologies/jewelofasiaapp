...
class NoDataScreen extends StatelessWidget {
  ...
  final String? image;
  const NoDataScreen({Key? key,  this.isShowButton = true, required this.title, this.image, this.subTitle, this.isFooter = true}) : super(key: key);
    ...
    return ResponsiveHelper.isDesktop(context) ? SingleChildScrollView(
      child: Column(
        children: [
          ...
          isFooter ? const FooterView() : const SizedBox(),
        ],
      ),
