      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        onTap != null ? InkWell(
          ...
          child: Padding(
            ...
            child: Text(
              'view_all'.tr,
              style: poppinsRegular.copyWith(fontSize: ResponsiveHelper.isDesktop(context) ? Dimensions.fontSizeLarge : Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.8)),
            ),
          ),
        ) : const SizedBox(),
      ]),
